...
(() => {
  const verifiedTripItems = [
    ...
    {type:'ticket', icon:'◇', title:'Louvre Museum', meta:'9/16 · 公式チケット購入確認済み · 日時はe-ticket記載 · LOCKED', verified:true},
  ...
  const additions = [
    ...
    {match:'Louvre Museum',ticketKey:'louvre-2026-09',bullets:['Musée du Louvre公式チケットサイトで8/23に購入確認','e-ticketは記名式・譲渡不可','入場時に本人確認書類の提示を求められる','e-ticket記載の日時に来館する必要あり','チケットPDF自体・注文番号・QRコードは公開データに保存しない']},
